...
var SUCCESS_MESSAGE = (
  ...
  >
    <div style="text-align: center; max-width: 480px; padding: 40px">
      <h1 style="font-size: 24px; color: #111; margin-bottom: 8px">
        Login successful
      </h1>
      <p style="color: #555; font-size: 16px; line-height: 1.5">
        You can close this window. Your OAuth token is stored at
      </p>
      <code
        style="
          ...
          margin-top: 4px;
        "
        >~/.config/linear-select-issue-cli/oauth-token.json</code
      >
      <p
        style="color: #777; font-size: 14px; line-height: 1.6; margin-top: 20px"
      >
        Your token was sent from Linear directly to your browser and stored on
        your computer by the CLI. The CLI has no server and your credentials are
        only ever held on your device.
      </p>
      <div
        style="
          background: #f0f0f0;
      ...
      >
        ...
        <div style="margin-bottom: 8px">
          <code
            ...
            >linear-cli -m</code
          >
          <span style="color: #666; font-size: 13px">Only your issues</span>
        </div>
        <div style="margin-bottom: 8px">
          <code
            style="
            ...
            >linear-cli -p</code
          >
          <span style="color: #666; font-size: 13px">Filter by project</span>
        </div>
        <div style="margin-bottom: 8px">
          <code
            style="
          ...
          >
          <span style="color: #666; font-size: 13px"
            >Loop actions (copy branch, open in browser, etc.)</span
          >
        </div>
        <div style="margin-bottom: 8px">
          <code
          ...
          >
          <span style="color: #666; font-size: 13px"
            >Output as JSON (good for agents!)</span
          >
        </div>
        <div style="margin-bottom: 8px">
          <code
          ...
          >
          <span style="color: #666; font-size: 13px"
            >Unassigned, triaged, priority &ge; (High) &mdash; my personal
            favorite</span
          >
        </div>
        <div>
          <code
            ...
            >linear-cli -h</code
          >
          <span style="color: #666; font-size: 13px">See all options</span>
        </div>
        <p
          style="
            color: #111;
        ...
        <code
          style="
            ...
            font-size: 13px;
          "
          >npm install -g linear-select-issue-cli@latest</code
        >
      </div>
      <p style="color: #777; font-size: 13px; margin-top: 20px">
        This is open-source software that you can audit yourself.
      </p>
      <div
        style="
          margin-top: 12px;
      ...
      >
        <a
          href="https://github.com/zsiegel92/linear_cli"
          target="_blank"
          style="
            display: inline-flex;
            align-items: center;
        ...
        >
        <a
          href="https://www.npmjs.com/package/linear-select-issue-cli"
          target="_blank"
          style="
            display: inline-flex;
            align-items: center;
            ...
            font-weight: 500;
          "
          ><svg height="18" width="18" viewBox="0 0 256 256" fill="white">
            <path d="M0 256V0h256v256z" fill="#cb3837" />
            <path d="M48 48v160h80V80h48v128h32V48z" fill="white" /></svg
          >npm</a
        >
      </div>
      <p style="color: #aaa; font-size: 13px; margin-top: 28px">
        Made with Love by Zach Siegel
      </p>
    </div>
  </body>
</html>
...
async function getAuthTokenWithClientIdOnly() {
  ...
  return new Promise((resolve, reject) => {
    ...
    const server = app.listen(PORT, () => {
      ...
      const authUrl = `https://linear.app/oauth/authorize?${import_qs.default.stringify(
        params
      )}`;
